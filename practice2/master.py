...
if __name__ == '__main__':
    ...
    comparator2("positive_practice_results_all_subjects.csv", "positive_practice_results.csv")
    video_book_validation(pd.read_csv("positive_practice_results_all_subjects.csv"),"positive_practice_results_all_subjects.csv")
    video_book_validation(pd.read_csv("positive_practice_results.csv"),"positive_practice_results.csv")



    df1=pd.read_csv('positive_practice_results_all_subjects.csv')
    df1.to_csv('positive_practice_results_all_subjects.csv', na_rep='NA',index=False)
    df2=pd.read_csv('positive_practice_results.csv')
    df2.to_csv('positive_practice_results.csv',index=False,na_rep='NA')

    df3=pd.read_csv('negative_practice_results_all_subjects.csv')
    df3.to_csv('negative_practice_results_all_subjects.csv',index=False,na_rep='NA')

    df4=pd.read_csv('negative_practice_results.csv')
    df4.to_csv('negative_practice_results.csv',index=False,na_rep='NA')
