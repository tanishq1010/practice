            ...
            for data in item["content"]:
                for data in data["data"]:
                    ...
                    try:
                        ...
                        df_herobanner_csv=pd.read_csv('PractiseHeroBanner.csv')
                        goal=home_data[2]
                        exam=home_data[1]
                    ...
                    #         df_negative_results.loc[len(df_negative_results)] = home_data + [duration, Type, id, title,"PRACTICEBANNER", embium_coins,subject,subject_tagged,"","","","","",""]
